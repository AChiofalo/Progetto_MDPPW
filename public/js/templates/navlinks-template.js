...
function showSessionLinks(active,role){
    ...
    return `${showCartLink(active)}
            <a class="nav-link clickableNavLink ${active==='login' ? 'active' : ''}" ${active==='login' ? 'aria-current="page"' : ''} href="/login">Login</a>
            <a class="nav-link clickableNavLink ${active==='sign up' ? 'active' : ''}" ${active==='sign up' ? 'aria-current="page"' : ''} href="/register">Sign Up</a>
            <a class="nav-link clickableNavLink ${active==='join us' ? 'active' : ''}" ${active==='join us' ? 'aria-current="page"' : ''} href="/join">Join Us</a>`     
...
function showCartLink(active){
    return  `<a class="nav-link clickableNavLink ${active==='cart' ? 'active' : ''}" ${active==='cart' ? 'aria-current="page"' : ''} href="/cart">
    Carrello
